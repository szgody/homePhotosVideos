<template>
  ...
  <header class="header">
    ...
    <nav class="nav-bar">
      ...
      <router-link :to="baseUrl + '/'">首页</router-link>
      <!-- Home page -->
      <router-link :to="baseUrl + '/photo'">照片</router-link>
      <!-- Photos page -->
      <router-link :to="baseUrl + '/video'">视频</router-link>
      <!-- Videos page -->
      <router-link :to="baseUrl + '/admin/processing'">处理</router-link>
      <!-- Processing page -->
    </nav>
  </header>
</template>
